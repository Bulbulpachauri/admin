        ...
        >
            <SwiperSlide>
                <div className="item w-full rounded-md overflow-hidden">
                    ...
                    <div className="info absolute top-0 -right-[100%] opacity-0 w-[50%] z-50 p-8 flex item-center flex-col justify-center transition-all duration-700">
                        ...
                        <h3 className="flex items-center gap-3 text-[18px] font-[500] w-full text-left mt-3 mb-3 relative -right-[100%] opacity-0">
                            Starting At Only <span className="text-red-500 text-[30px]
                             font-[700]">$59.00</span></h3>
