...
const Footer = () => {
    ...
    return (
        <>
            <footer className="py-6 bg-[#fafafa]">
                <div className="container">
                    <div className="flex items-center justify-center gap-2 py-8 pb-8">
                        ...
                        <div className="col flex items-center justify-center flex-col group w-[15%]">
                            <PiKeyReturnLight className="text-[40px] transition-all duration-300 group-hover:text-red-500 group-hover:-translate-y-1" />
                            <h3 className="text-[16px] font-[600] mt-3">30 Days Returns</h3>
                            <p className="text-[12px] font-[500]">For an Exchange Product</p>
                        </div>

                        <div className="col flex items-center justify-center flex-col group w-[15%]">
                            <BsWallet2 className="text-[40px] transition-all duration-300 group-hover:text-red-500 group-hover:-translate-y-1" />
                    ...
                    <div className="footer flex  py-12">
                        <div className="part1 w-[25%] border-r border-[rgba(0,0,0,0.2)]">
                            ...
                            <Link className="link text-[13px]" to="mailto:someone@example.com">sales@yourcompany.
                                com</Link>

                            <span className="text-[20px] font-[600] block w-full mt-3 mb-5 text-red-500">
                                (+91) 8171-306-923
                            </span>
            ...
            <div className="bottomStrip border-t border-[rgba(0,0,0,0.1)] py-4 bg-[#fafafa] ">
                <div className="container flex items-center justify-between">
                    <ul className="flex items-center gap-2">
                        <li className="list-none">
                            <Link to="/" target="_blank" className="w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] flex items-center justify-center group hover:bg-red-400 transition-all">
                        ...
                        <li className="list-none">
                            <Link to="/" target="_blank" className="w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] flex items-center justify-center group hover:bg-red-400 transition-all">
                                <FaLinkedinIn className="text-[15px] group-hover:text-white" />
                            </Link>
                        </li>
                    </ul>
                 ...
                 onClick={context.toggleCartPanel(false)}
                  ...
                  className="cartPanel">
                    <div className="flex items-center justify-between py-3 px-4 gap-3 border-b border-[rgba(0,0,0,0.1) overflow-hidden">
                      ...
                      <IoCloseSharp className="text-[20px] cursor-pointer" onClick={()=>context.openCartPanel(false)}/>
                    </div>
