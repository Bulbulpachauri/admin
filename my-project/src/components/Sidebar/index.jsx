    ...
    <aside className="sidebar py-5">
      <div className="box">
        ...
        <Collapse isOpened={isOpenCategoryFilter}>
          <div className="scroll px-4 relative -left-[13px]">
            ...
            <FormControlLabel control={<Checkbox size="small" />} label="Footwer" className="w-full" />
      ...
      <div className="box">
        ...
        <Collapse isOpened={isOpenAvailFilter}>
          <div className="scroll px-4 relative -left-[13px]">
            <FormControlLabel control={<Checkbox size="small" />} label="Availability (17)" className="w-full" />
            <FormControlLabel control={<Checkbox size="small" />} label="In Stock (10)" className="w-full" />
            <FormControlLabel control={<Checkbox size="small" />} label="Not Availability (1)" className="w-full" />
          </div>
        </Collapse>
      </div>
